...
\begin{outline}
    ...
    \1 Definitions and Assumptions for the model
...
A perceptron\cite{rosenblatt1958perceptron} is one of the simplest types of artificial neural networks and is a foundational concept in machine learning. 
...
\begin{itemize}
    ...
    \item \textbf{Past 3D }: The hyperplane separates the space in a way that can't be 3-dimensionally represented and is called a hyperplane.
\end{itemize}
