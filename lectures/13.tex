%+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
% SUMMARY    : Wrap up SVM, Using f(a) to optimize,  If optimized we know w and b,
%              Try optimizing using direct method but this will present an issue, 
%              Try optimizing with indirect methods using gradient descent based methods,
%              Try optimizing with backpropagation, Backpropagation is the crux of DL (deep learning),
%              Deep learning provides a solution for non-linear data
