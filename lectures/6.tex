...
\section*{Objectives}
\begin{itemize}
  \item Summarize K-Nearest Neighbors and model evaluation techniques
  \item Define the perceptron algorithm and its decision boundary
  \item Explain the kernel trick for nonlinear separation
\end{itemize}
